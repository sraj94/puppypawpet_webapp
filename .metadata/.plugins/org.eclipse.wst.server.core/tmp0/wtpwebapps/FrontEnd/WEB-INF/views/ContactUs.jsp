...
<body>
	...
	<div class="contact contentSection">
					...
					<div class="col-md-8  ">
						<div class="form-group">
							<label for="title"><span
								style="font-size: 25px; font-color: black;">Get in touch
									with us</span></label><br> <label for="exampleInputUsername">Your
								name</label> <input type="text" class="form-control" id=""
